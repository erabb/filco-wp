...
function crb_post_type_order_title_with_thumb($title, $id = 0) {
	$show_on_pages = array(
		'order-post-types-crb_recipe',
		'order-post-types-crb_tip',
		'order-post-types-post',
	);

	if ( is_admin() && in_array(crb_request_param('page'), $show_on_pages) ) {
		$title = '<div style="width: 100px; display: inline-block;">' . crb_column_render_post_thumbnail($id) . '</div> ' . $title;
	}
...
function crb_admin_post_thumbnail_html( $content ) {
	if ( in_array(crb_get_post_type(), array('crb_recipe', 'crb_tip', 'post')) ) {
		$content .= '<p>Please make sure that you upload images that are wider and taller than 385px, so they can be properly cutoff on the home page.</p>';
	}
...
function crb_get_unregistered_image_size($name) {
	$unregistered_image_sizes = array(
		...
		'crb_about_columned_image' => array(
			'width' => 82,
			'height' => 82,
			'crop' => false,
			'retina' => 2,
		...
		'crb_home_boxes_box1' => array(
			'width' => 185,
			'height' => 190,
			'crop' => true,
		),
		'crb_about_scanner_image' => array(
			'width' => 104,
			'height' => 104,
			'crop' => true,
			'retina' => 2,
		),
		'crb_search_image' => array(
			'width' => 172,
			'height' => 172,
			'crop' => true,
			'retina' => 2,
		),
		'crb_home_boxes_box2' => array(
			'width' => 185,
			'height' => 190,
			'crop' => true,
		),
		'crb_home_boxes_box3' => array(
			'width' => 186,
			'height' => 385,
			'crop' => true,
		),
		'crb_related_post_image' => array(
			'width' => 284,
			'height' => 284,
			'crop' => true,
			'retina' => 2,
		),
		'crb_home_boxes_box4' => array(
			'width' => 382,
			'height' => 188,
			'crop' => true,
		),
		'crb_home_boxes_box5' => array(
			'width' => 185,
			'height' => 190,
			'crop' => true,
		),
		'crb_home_boxes_box6' => array(
			'width' => 185,
			'height' => 190,
			'crop' => true,
		),
		'crb_about_image' => array(
			'width' => 768,
			'height' => 286,
			'crop' => true,
		),
		'crb_top_single_image' => array(
			'width' => 768,
			'height' => 286,
			'crop' => true,
		),
		'crb_home_callout_background' => array(
			'width' => 768,
			'height' => 545,
			'crop' => true,
		),
