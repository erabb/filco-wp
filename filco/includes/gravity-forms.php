...
// Fix text-align: justify not working, because of the lack of spacings in the form html
add_filter('gform_get_form_filter', 'crb_gform_get_form_filter', 10, 2);
function crb_gform_get_form_filter($form_html, $form) {
	$form_html = str_replace('<li', '   <li', $form_html);
